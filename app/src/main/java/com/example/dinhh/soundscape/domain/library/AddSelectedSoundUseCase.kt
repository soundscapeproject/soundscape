...
class AddSelectedSoundUseCase (private val addSound: AddSound, private val schedulerProvider: SchedulerProvider) {
    ...
    fun execute(selectedSound: String, selectedPosition: Int, title: String, length: Int , category: String, volume: Int): Completable {
        return addSound.addSound(selectedSound, selectedPosition, title, length, category, volume)
